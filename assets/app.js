...
(function(){if(document.getElementById('pd-legend-stack'))return;var s=document.createElement('style');s.id='pd-legend-stack';s.textContent='.legend-item--stack{align-items:flex-start;gap:6px}.legend-item__text{display:flex;flex-direction:column;line-height:1.2;min-width:0}.legend-item__name{font-size:.74rem;font-weight:600}.legend-item__meta{font-size:.66rem;font-family:var(--font-mono);white-space:nowrap}.chart-legend{flex-wrap:wrap;row-gap:8px}.chart-card-footer{flex-wrap:wrap}.chart-val-summary{white-space:normal;overflow-wrap:anywhere;flex-shrink:1;text-align:right;max-width:100%;line-height:1.35}';document.head.appendChild(s);})();
